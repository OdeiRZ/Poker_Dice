...
2. Cada jugador, en su turno, tira los dados y puede **guardar** los que le interesen haciendo clic sobre ellos (mecánica *hold and reroll*, como en el Yahtzee): los dados guardados se resaltan y no se vuelven a lanzar en las siguientes tiradas del mismo turno. Al tirar, los dados que se relanzan "caen" sobre el tablero con un pequeño rebote, en cascada (uno tras otro); los guardados no se tocan. Mientras dura, los botones y las casillas de guardar quedan bloqueados.
